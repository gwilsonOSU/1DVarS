...
bkgd = hydroWaveModel(prior.x,prior.h,prior.H0,prior.theta0,prior.omega,prior.ka_drag,prior.tau_wind,prior.detady,prior.dgamma,prior.dAw,prior.dSw);
horig=prior.h;
for fld=fields(bkgd)'
  fld=cell2mat(fld);
...
for n=1:nitermax
  ...
  bkgd = hydroWaveModel(posterior.x,posterior.h,...
                        ...
                        posterior.ka_drag,posterior.tau_wind,posterior.detady,...
