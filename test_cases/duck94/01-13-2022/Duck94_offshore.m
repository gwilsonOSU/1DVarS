...
% hold off
yline(0,'--k')
title('Calculated transport per wave - Duck 94 Offshore Migration')
xlabel('wave')
...
set(gca,'xscale','log')
set(gca,'yscale','log')
title('Magnitude of transport (log log scale) - Duck 94 Offshore Migration')
...
hold off
title('cumulative mean transport - Duck 94 Offshore Migration')
ylabel('q mean(m^2/s)')
xlabel('wave')
yline(0,'--k')
set(gca,'FontSize',18)
