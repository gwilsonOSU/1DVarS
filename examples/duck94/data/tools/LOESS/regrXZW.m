function [b,brmse,sk,n,msz] = regrXZW(X,z,w);
% 
% [b,brmse,sk,n,msz] = regrXZW(X,z,w);
% 
...
if(nz~=n | nw~=n | nw~=nz)
   error('X and z or w are different lengths')
end
b = repmat(nan,m,1);
brmse = b;
sk=nan;
...
% do the weighted least squares problem
XX_inv = svdInvert(XX);
b = XX_inv*XZ'; 
...
%
% $Id: regrXZW.m,v 1.1 2004/08/20 00:51:07 stanley Exp $
%
% $Log: regrXZW.m,v $
...
%
%key interp 
%comment  Useful weighted least squares regression routine 
%
