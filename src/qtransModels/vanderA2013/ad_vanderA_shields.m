function [ad_d50,ad_d90,ad_udelta,ad_uhat,...
...
% Note A is an 2x8 matrix.  After augmenting this TL system of eqns
% with the state variables ksd and ksw, the "full" TL model is a 10x10 matrix.
% The AD code corresponds to transposing this.
Ap=[[eye(8); A] zeros(10,2)];  % full 10x10 matrix for TL model
ad_rhs=[ad_d50 ad_d90 ad_ahat ad_mu ad_uhat ad_udelta ad_eta ad_lambda ad_ksd ad_ksw]';
ad_rhs = Ap'*ad_rhs;
ad_d50   =ad_rhs(1);
ad_d90   =ad_rhs(2);
ad_ahat  =ad_rhs(3);
