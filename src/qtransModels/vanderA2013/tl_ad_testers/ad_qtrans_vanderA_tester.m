...
[Aw,Sw,Uw,uwave_wksp]=Uwave_ruessink2012_params(1.4*Hrms,k,omega,h);
param.n=1.2;
param.m=11;
...
eps = 0.01;
n=10;
F = eps*rand(16,n);  % 1st dim is number of tl input parameters
for i=1:n
  % TL model: TL*F
  tl_d50        =F(1,i);
  tl_d90        =F(2,i);
  ...
  g(:,i)=[ad_d50;ad_d90;ad_h;ad_Hrms;ad_kabs;ad_omega;ad_udelta(:);ad_ws;ad_Aw;ad_Sw;ad_Uw;
