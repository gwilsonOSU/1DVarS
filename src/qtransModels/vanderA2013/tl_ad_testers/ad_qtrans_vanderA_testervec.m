...
% inoutvar='utot';  %vec
% inoutvar='Omegai';
% inoutvar='arg_Kidenom1';  %vec
% inoutvar='Kidenom1';
% inoutvar='arg_Kidenom2(10)';  %vec
% inoutvar='Kidenom2'; %Ok
% inoutvar='Ki';
% inoutvar='arg_qsCc(55)';  %vec, ok
% inoutvar='qsCc';  %NO
% inoutvar='ws';  %nan??
% inoutvar='arg_Ksdenom1'; %vec
% inoutvar='Ksdenom1';
% inoutvar='arg_Ksdenom2';  %vec
% inoutvar='Ksdenom2';
% inoutvar='arg_Kbdenom1'; %vec
% inoutvar='Kbdenom1';
% inoutvar='arg_Kbdenom2'; %vec
% inoutvar='Kbdenom2';
% inoutvar='bedSuspRatio';
% inoutvar='Omegab';
% inoutvar='Omegas';
% inoutvar='Kb';
% inoutvar='Ks';
% inoutvar='arg_qsCf(45)';  %ok
% inoutvar='qsCf';
% inoutvar='arg_qbCf(34)';  %ok
% inoutvar='qbCf';
