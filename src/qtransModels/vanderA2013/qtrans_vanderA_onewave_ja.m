function [qs,workspc]=qtrans_vanderA_onewave_ja(d50,d90,wsc,wst,udelta,uhat,uhatc,uhatt,T,Tc,Tt,Ttu,Tcu,c,param)
%
...
% c   : wave phase speed, m/s (Note: Set to empty [] for flow-tunnel experiments)
...
nlambda=neta;
eta=ahat*meta*neta*(.275-.022*psihat^.42); % eqn B1
lambda=ahat*mlambda*nlambda*(1.97-0.44*psihat^.21); % eqn B2
...
ucrvec=[utildecr+udabs,0];  % eqn 12, TODO: wave angle?
utrvec=[-utildetr+udabs,0];  % eqn 13
